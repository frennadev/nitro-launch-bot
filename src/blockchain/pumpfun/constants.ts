...
// Additional constants for token creation
export const MAESTRO_FEE_ACCOUNT = new PublicKey(
  "GRx7vW9ndEhqiL5e8scBQTdse3db9GCVyx9JyH2Ho7R"
);
export const MAESTRO_FEE_AMOUNT = 0.01; // 0.01 SOL
