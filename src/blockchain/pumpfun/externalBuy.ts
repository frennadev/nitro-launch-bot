...
import { getCachedPlatform, markTokenAsPumpFun, markTokenAsPumpswap } from "../../service/token-detection-service";
 ...
 * This replaces the complex platform detection with the reliable bonding curve method
 */
export async function executeExternalBuy(
  ...
  try {
    ...
    // Try PumpFun first using bonding curve detection (embedded in executeExternalPumpFunBuy)
